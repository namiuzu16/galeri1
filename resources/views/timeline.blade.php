...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand-md navbar-dark navbar-black">
    <div class="container">
      ...
      <div class="collapse navbar-collapse order-3" id="navbarCollapse">
        ...
        <ul class="navbar-nav">
          <li class="nav-item">
            <a data-toggle="modal" data-target="#modalupload" href="" class="nav-link btn btn-primary">Upload <i class="fas fa-upload"></i></a>
          </li>
          {{-- <li class="nav-item">
      ...
      <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link btn btn-danger" data-toggle="modal" data-target="#modallogout" href="#" role="button">Logout
            <i class="fas fa-sign-out-alt fa-sw fa-fw"></i>
          </a>
        </li>
      </ul>
    </div>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
            ...
            <div>
              ...
              <div class="timeline-item mb-2">
                ...
                <div class="timeline-footer">
                  <a data-toggle="modal" data-target="#modaledit{{ $galeri->id }}" class="btn btn-warning btn-sm">Edit</a>
                  <a data-toggle="modal" data-target="#modalhapus{{ $galeri->id }}" class="btn btn-danger btn-sm">Delete</a>
                </div>
              </div>
            </div>
            {{-- <div class="post">
        ...
        <div class="modal fade" id="modalimg{{ $galeri->id }}" tabindex="-1">
        ...
        <div class="modal fade" id="modalhapus{{ $galeri->id }}" tabindex="-1">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <button data-dismiss="modal" class="btn btn-secondary">Close</button>
                <a href="{{ route('galeri.show', $galeri->id) }}" class="btn btn-primary">Sure</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="modal fade" id="modaledit{{ $galeri->id }}" tabindex="-1">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <h3 class="modal-title">Edit And Update Image</h3>
              </div>
              <form action="{{ route('galeri.update',$galeri->id) }}" enctype="multipart/form-data" method="post">
              @csrf
              @method('PUT')
              <div class="modal-body">
                <div class="form-group">
                  <label for="judul">Judul</label>
                  <input type="text" value="{{ $galeri->judul }}" name="judul" id="" class="form-control">
                </div>
                <div class="form-group">
                  <label for="deskripsi">Deskripsi</label>
                  <textarea name="deskripsi" id="" class="form-control">{{ $galeri->deskripsi }}</textarea>
                </div>
                <div class="form-group">
  ...
  <div class="modal fade" id="modallogout" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h3 class="modal-title">Sign Out User</h3>
        </div>
        <div class="modal-body">
        ...
        <div class="modal-footer">
          <button data-dismiss="modal" class="btn btn-secondary">Close</button>
          <a href="{{ url('metu') }}" class="btn btn-primary">Sure</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="modal fade" id="modalupload" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="{{ url('galeri') }}" enctype="multipart/form-data" method="post">
        @csrf
        <div class="modal-body">
          <div class="form-group">
            <label for="judul">Judul</label>
